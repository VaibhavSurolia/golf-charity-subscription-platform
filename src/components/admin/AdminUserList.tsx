            ...
            <div className="flex items-center gap-4">
              ...
              <div className="space-y-0.5">
                ...
                <div className="flex flex-wrap items-center gap-x-3 gap-y-1">
                  {full && <p className="text-[10px] text-white/50 truncate max-w-[120px]">{user.email}</p>}
                  ...
                  {full && (
                    <>
                      <div className="w-1 h-1 rounded-full bg-white/10 hidden sm:block" />
                      <p className="text-[10px] text-white/20 uppercase tracking-tighter">Joined {new Date(user.created_at).toLocaleDateString()}</p>
                    </>
                  )}
                </div>
              </div>
